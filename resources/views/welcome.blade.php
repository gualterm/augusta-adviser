...
<p>{{ $hour->day_name }}: {{ substr($hour->open_time, 0, 5) }}h – {{ substr($hour->close_time, 0, 5) }}h@if($hour->lunch_start) <small style="color:#999">(almoço {{ substr($hour->lunch_start,0,5) }}–{{ substr($hour->lunch_end,0,5) }})</small>@endif</p>
@endforeach
@endif
</div>
</div>
